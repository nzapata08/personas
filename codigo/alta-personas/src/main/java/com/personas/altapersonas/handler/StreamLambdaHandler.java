package com.personas.altapersonas.handler;
...
import com.personas.altapersonas.AltaPersonasApplication;
...
public class StreamLambdaHandler implements RequestStreamHandler {
	...
	static { 
		try { 
			handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(AltaPersonasApplication.class);
